...
const translations = {
  zh: {
    ...
    "footer.description": "专注于人工智能技术创新，为文旅产业提供智能内容生成和虚拟人交互解决方案。",
    "footer.links": "快速链接",
    "footer.contact": "联系方式",
    ...
    "footer.addresses.hangzhouDetail": "浙江省杭州市余杭区天目山路2988号",
